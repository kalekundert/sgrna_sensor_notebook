...
exclude_patterns = [ #
        ...
        'Thumbs.db',
        '.DS_Store',
        '20170329_test_multiple_spacers/doench16',
]
...
htmlhelp_basename = 'sgRNAsensordoc'
...
latex_documents = [ #
    (master_doc, 'sgRNAsensor.tex', 'sgRNA sensor Documentation',
     'Kale Kundert', 'manual'),
]
...
man_pages = [ #
    (master_doc, 'sgrnasensor', 'sgRNA sensor Documentation',
     [author], 1)
]
...
texinfo_documents = [ #
    (master_doc, 'sgRNAsensor', 'sgRNA sensor Documentation',
     author, 'sgRNAsensor', 'One line description of project.',
     'Miscellaneous'),
]
